...
const training_samples = ['a.wav', 'b.wav'];

// const test_samples = [
//     'test_1.wav',  'test_8.wav',
//     'test_2.wav',  'test_18.wav',
//     'test_3.wav',  'test_10.wav',
//     'test_14.wav', 'test_20.wav',
//     'test_19.wav', 'test_4.wav',
//     'test_5.wav',  'test_6.wav',
//     'test_13.wav', 'test_17.wav',
//     'test_12.wav', 'test_15.wav',
//     'test_7.wav',  'test_16.wav',
//     'test_11.wav', 'test_9.wav'
// ];
...
for (let i = 0; i < test_samples.length; i++) {
    ...
    const test = new ScreenUIElements(
        ...
        new QuestionnaireItemMediaAudioRepeatable('session', '', false, `media/session1/`+test_samples[i], true, "Play"),
        new QuestionnaireItemDefinedOne('scale', '<h3>Rate the quality of the audio:</h3>', true, ["Bad", "Poor", "Fair", "Good", "Excellent"])
    );
    screens.push(test);
}
...
for (let i = 0; i < test_samples.length; i++) {
    ...
    const test = new ScreenUIElements(
        ...
        new UIElementHTML('session', 'Test '+ testcountShown +' out of '+test_samples.length),
        new QuestionnaireItemMediaAudioRepeatable('session', '', false, `media/session2/`+test_samples[i], true, "Play"),
        new QuestionnaireItemDefinedOne('scale', '<h3>Rate the quality of the audio:</h3>', true, ["Bad", "Poor", "Fair", "Good", "Excellent"])
    );
    screens.push(test);
}
...
for (let i = 0; i < test_samples.length; i++) {
    ...
    const test = new ScreenUIElements(
        ...
        new UIElementHTML('session', 'Test '+ testcountShown +' out of '+test_samples.length),
        new QuestionnaireItemMediaAudioRepeatable('session', '', false, `media/session3/`+test_samples[i], true, "Play"),
        new QuestionnaireItemDefinedOne('scale', '<h3>Rate the quality of the audio:</h3>', true, ["Bad", "Poor", "Fair", "Good", "Excellent"])
    );
    screens.push(test);
}
...
for (let i = 0; i < test_samples.length; i++) {
    ...
    const test = new ScreenUIElements(
        ...
        new UIElementHTML('session', 'Test '+ testcountShown +' out of '+test_samples.length),
        new QuestionnaireItemMediaAudioRepeatable('session', '', false, `media/session4/`+test_samples[i], true, "Play"),
        new QuestionnaireItemDefinedOne('scale', '<h3>Rate the quality of the audio:</h3>', true, ["Bad", "Poor", "Fair", "Good", "Excellent"])
    );
    screens.push(test);
}
